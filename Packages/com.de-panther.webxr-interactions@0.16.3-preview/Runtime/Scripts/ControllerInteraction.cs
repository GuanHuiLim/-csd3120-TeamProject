...
namespace WebXR.Interactions
{
  public class ControllerInteraction : MonoBehaviour
  {
    ...
    private bool currentRigidBody_isKinematic = false;
    ...
    public void Pickup()
    {
      ...
      if (!currentRigidBody)
        return;
      //currentRigidBody_isKinematic = currentRigidBody.isKinematic;
      
      //disable kinematic temporarily
      //if (currentRigidBody_isKinematic)
      //{
